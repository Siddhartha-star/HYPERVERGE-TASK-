...
from api.ws_manager import router as websocket_router
...
async def validation_exception_handler(
    ...
    # This handler can be used to customize validation error responses.
    # For example, returning a more user-friendly error message.
